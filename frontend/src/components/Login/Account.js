        ...
        <div className={styles.innerleftContainer}>
          <div className={styles.content}>
            ...
            <div className={styles.bestViewsubhead}>
              Here, you can access your personal account to view and manage your
              camera settings, photos, and videos. Simply enter your username
              and password to login and begin exploring all the features our
              site has to offer.
            </div>
